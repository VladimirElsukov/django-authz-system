...
4. Проведите первоначальные миграции базы данных:
```bash
...
- Пользователи: `admin@example.com`, `editor@example.com`
- Пароль: одинаковый — `password`
- Определены роли и права доступа для ресурсов "Пользователи" и "Статьи".

Вы можете отправлять запросы через инструменты вроде Swagger или команды curl.
